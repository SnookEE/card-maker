...
blank_page = ones(pheight,pwidth,3).*255;
...
% cutlines = draw_cutlines(blank_page);

cutlines = full_cutlines(blank_page);
...
imwrite(cutlines,"cutlines.png");



%%

mirrored = fliplr(cutlines);


[r,g,b] = imsplit(mirrored);

r(r==0) = 255;

mirrored = cat(3,r,g,b);
